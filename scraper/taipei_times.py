...
for keyword in keywords:
    ...
    url_link = "https://www.taipeitimes.com/News/list?section=all&reportrange=January%201,%202021%20-%20July%2001,%202021&keywords={}".format(
        keyword)
...
for url in urls:
    ...
    try:
        ...
        csv_values = [" ".join(headline.split()), " ".join(article.split()), " ".join(author.split()), url[2],
                      "".join(url[0]), "".join(date), url[3]]
